...
import { updateRecruiter } from "@/actions/recruiter";
...
const UpdateApplicant = () => {
    ...
    const handleSubmit = (e) => {
        ...
        updateRecruiter(employerProfile).then(data => {
            if (data.error) {
            ...
            <>
                <div class="w-full max-w-xl mx-auto component flex items-start justify-center overflow-x-hidden py-4">
                    <form onSubmit={handleSubmit} method="post">
                        ...
                        <button className="bg-teal-500 hover:bg-teal-600 text-white py-2 px-3 rounded" type="submit">Update Profile</button>
                    </form>
                </div >
            </>
        )
